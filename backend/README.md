...
## Project Structure
    ...
    ├── cooperation_island_37829  # Django project configurations
...
1. Clone this repo and `cd cooperation_island_37829`
...
2. Clone this repo and `cd cooperation_island_37829`
